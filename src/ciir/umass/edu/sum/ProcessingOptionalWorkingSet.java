 ...
 * @author irmarc, sjh
 */
public class ProcessingOptionalWorkingSet extends ProcessingModel {
  ...
  public ProcessingOptionalWorkingSet(LocalRetrieval lr) {
    retrieval = lr;
  ...
  public ScoredDocument[] execute(Node queryTree, Parameters queryParams ) throws Exception {
	  if(!queryParams.containsKey("working"))
		  return execute1(queryTree, queryParams);
	  else
		  return execute2(queryTree, queryParams);
  }
